...
CxxTest::StaticSuiteDescription suiteDescription_ToyProblemTestSuite( "/Users/davidraleigh/code/davidraleigh/toy-problems/toy-problems-cpp/toy-problems-tests/toy-problem-tests.h", 21, "ToyProblemTestSuite", suite_ToyProblemTestSuite, Tests_ToyProblemTestSuite );

static class TestDescription_suite_ToyProblemTestSuite_testNoOdds : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_ToyProblemTestSuite_testNoOdds() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 32, "testNoOdds" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testPowerOf4() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 64, "testPowerOf4" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testNonRecursivePowerOf4() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 74, "testNonRecursivePowerOf4" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testFactorialDivision() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 88, "testFactorialDivision" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testGreatestNonAdjacentWeights() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 95, "testGreatestNonAdjacentWeights" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testSumOfSquaresShortestSet() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 194, "testSumOfSquaresShortestSet" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testSumOfSquaresAllSet() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 265, "testSumOfSquaresAllSet" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testLevenshteinDistance() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 296, "testLevenshteinDistance" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testFibonacciaSequence() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 308, "testFibonacciaSequence" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testIsPrime() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 323, "testIsPrime" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testGetPrimes() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 379, "testGetPrimes" ) {}
...
public:
 TestDescription_suite_ToyProblemTestSuite_testCoinSums() : CxxTest::RealTestDescription( Tests_ToyProblemTestSuite, suiteDescription_ToyProblemTestSuite, 400, "testCoinSums" ) {}
